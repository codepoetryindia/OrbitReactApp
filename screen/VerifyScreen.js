            ...
            <View style={{ flex: 1 }}>
              <View style={{ flex: 0.35 }}>
                ...
                <View style={styles.verify_description}>
                  ...
                  >
                    You are just three steps away from joining the best banking
                    community ever
                  </Text>
                </View>
              </View>
                    ...
                    <View
                      style={
                        this.state.verify_step == 1
                          ? styles.verify_step_body_active
                          : styles.verify_step_body
                      }
                    >
                      <Text
                        style={
                          this.state.verify_step == 1
                            ? styles.verify_step_text_active
                            : styles.verify_step_text
                        }
                      >
                        1
                      </Text>
                ...
                <View style={styles.body}>
                  {this.state.verify_step == 2 && (
                    <VerifyEmailComponent
                      onChangeLoadingBar={(value) =>
                        this.setState({ isLoading: value })
                      }
                      textEmail={global.user_info.email}
