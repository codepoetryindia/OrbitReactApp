        ...
        <View style={styles.body}>
          ...
          <View style={styles.more}>
            ...
            <View style={styles.more_body}>
              ...
              <TouchableOpacity
                style={styles.more_item}
                onPress={() => this.props.navigation.navigate("IssueScreen")}
              >
                <View style={{ flex: 0.05 }} />
                <View style={{ flex: 0.5 }}>
                  <Text style={styles.button_text}>Contact Support</Text>
                </View>
                <View style={{ flex: 0.3, justifyContent: "center" }}>
                  <Image
                    source={Images.help_ticket}
                    style={styles.ticket_img}
                  />
                </View>
                <View
                  style={{
