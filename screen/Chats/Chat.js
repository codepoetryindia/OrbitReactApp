...
export default class Chat extends Component {
    ...
    constructor(props) {
        super(props);
        this.db = openDatabase({ name: 'mishirn.db' });
        this.bot_id = "8f4375d8-bff2-491f-9ca1-bfa3acb41740";
        this.client_id = "b-dc7013d6-cffd-11ea-b5f1-068ffe2d1262";

        this.botIcon = 'https://naxetra.mishi.ai/static/common/images/bot.png';
        ...
        this.host = 'https://naxetra.mishi.ai';
    ...
    processMessage(message) {
        ...
        if (message && message.nerMeta) {
            ...
            if (entityType == 'MS.ATTACHMENT' || entityType == 'MS.ATTACHMENT_OR_STRING') this.isAttachmentReq = true;
        ...
        } else if (message && message.nerMeta && message.nerMeta.entityType && message.nerMeta.entityType == 'MS.DATE') {
            this.insertConversationToDB({
                type: 'date',
                position: 'left',
                bot_id: this.bot_id,
    ...
    callToSetState(entityType) {
        this.setState({
            ...
            viewArr: this.state.viewArr,
            isDateTimePickerVisible: this.state.isDateTimePickerVisible,
            isAttachmentReq: (entityType == 'MS.ATTACHMENT' || entityType == 'MS.ATTACHMENT_OR_STRING') ? true : false,
    ...
    updateStateForImage = async (uri, filename, filetype) => {
        let baseurl =  "https://naxetra.mishi.ai/file/" + this.config.senderId + "/upload";
            ...
            .uploadProgress((written, total) => {
                ...
                if (resp.respInfo.status == 200) {
                    ...
                    var message = {
                        ...
                        file_url: "https://naxetra.mishi.ai" + "/file/" + encodeURI(data1.file_token),
                        file_name: filename,
                        file_type: filetype
                    };
