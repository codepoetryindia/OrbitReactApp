...
export default class PurchaseProducts extends React.Component {
    static navigationOptions = {
        title: 'Add Products for Invoice'
    };

    async componentDidMount () {
        analytics().setCurrentScreen("Purchase Product", "Purchase Product");
    }
    ...
    render() {
        ...
        return (
            <View style={{flex:1, justifyContent: "center"}}>
                <Text style={{justifyContent: "center", alignSelf:"center"}}>This is Screen for adding products for purchase invoice</Text>
