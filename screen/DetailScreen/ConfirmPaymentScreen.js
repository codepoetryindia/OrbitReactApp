...
import { ActivityIndicator, Clipboard, Image, ImageBackground, SafeAreaView, Share, StyleSheet, Text, ToastAndroid, TouchableOpacity, View } from 'react-native';
...
export default class ConfrimPaymentScreen extends Component {
    ...
    componentDidMount() {
        if (global.link != undefined && global.link != '') {
            ...
            this.setState({url : 'https://orbit.money/'})
        }
        analytics().setCurrentScreen("Confirm Payment", "Confirm Payment");
