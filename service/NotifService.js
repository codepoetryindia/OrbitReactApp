...
export default class NotifService {
  ...
  customNotification(data){
    const defParams = { title:"You have a new notification", message:"You have a new notification", data:{}};
     const finalParams = { ...defParams, ...data }
     PushNotification.localNotification({
        ...
        bigText: finalParams.msg, // (optional) default: "message" prop
