...
export default class CompanyDetail extends Component {
  ...
  componentDidMount() {
    ...
    analytics().setCurrentScreen("Company Details", "Company Details");
  }
  ...
  onSubmit = () => {
    ...
    var obj = {
      vat_type: this.state.account_method == 1 ? "cash" : "accural",
      vat: this.state.vat_number,
      logo: this.state.logo,
      otp: "",
    };

    OtherService.getOTPByCompanydetail(global.token)
      .then((res) => {
  ...
  checkReady() {
    ...
    var vat = 0;
    if (!global.user_info.vat) vat = 1;
    else vat = 0;

    if (
      this.state.account_method != vat_type ||
      global.user_info.vat != this.state.vat_number ||
      vat != this.state.active_type
    ) {
          ...
          <View style={{ flex: 1 }}>
              ...
              >
                ...
                <View style={styles.business_detail}>
                  ...
                  {/* <View style={styles.business_item}>
                    ...
                    <Text style={styles.value}>
                      {global.user_info.company_status == "active"
                        ? "Active"
                        : "Unactive"}
                    </Text>
                  </View> */}
                ...
                <View style={styles.officer_detail}>
                  ...
                  <View style={styles.officer_item}>
                    ...
                    <Text style={styles.value}>
                      {global.user_info.officers.length == 0
                        ? ""
                        : global.user_info.officers[0].name}
                    </Text>
                  </View>
                  <View style={styles.officer_item}>
                  ...
                  <View style={styles.officer_item}>
                    ...
                    <Text style={styles.value}>
                      {global.user_info.officers.length == 0
                        ? ""
                        : global.user_info.officers[0].function}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.business_detail}>
                  ...
                  <View style={styles.business_item}>
                    ...
                    {!this.state.isEditVATNumber ? (
                      ...
                      <TextInput
                        ...
                        onChangeText={(value) =>
                          this.setState({ vat_number: value })
                        }
                        style={{
                          flex: 0.48,
                    ...
                    >
                      ...
                      >
                        {!this.state.isEditVATNumber ? "EDIT" : "SAVE"}
                      </Text>
                    </TouchableOpacity>
                  </View>
                  <View style={styles.business_item}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        this.setState({
                          account_method:
                            this.state.account_method == 0 ? 1 : 0,
                        });
                        this.checkReady();
                      }}
                    >
                  ...
                  <View style={styles.business_item}>
                    ...
                    >
                      <Image
                        source={{
                          uri: "data:image/png;base64," + this.state.logo,
                        }}
                        style={styles.image}
                        resizeMode="contain"
                      />
                ...
                <View style={{ marginBottom: 40 * metrics }} />
              </View>
            </ScrollView>
            <View style={global_style.bottom_button_body}>
              <TouchableOpacity
                style={
                  this.state.isReady
                    ? global_style.bottom_active_submit_btn
                    : global_style.bottom_submit_btn
                }
