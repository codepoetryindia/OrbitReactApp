...
export default class PersonalSettingScreen extends Component {
  ...
  saveDate() {
    ...
    OtherService.getOTPPersonal(global.token)
      .then((res) => {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.body}>
            <View style={{ position: "relative" }}>
              ...
              />
              <TouchableOpacity
                style={styles.carmera}
                onPress={() => this.changeSelife()}
              >
                <MaterialIcons
                  name="camera-alt"
                  size={28 * metrics}
            ...
            {!this.state.editing_phone ? (
              <View style={styles.item}>
                ...
                <View style={{ flexDirection: "row" }}>
                  <Text style={[styles.value, { flex: 0.9 }]}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => this.setState({ editing_phone: true })}
                  >
                    <MaterialIcons
                      name="edit"
                      color={Colors.main_blue_color}
              ...
              <View style={styles.editing_item}>
                ...
                <View style={{ flexDirection: "row", marginTop: 10 * metrics }}>
                  <View style={{ flex: 0.85, flexDirection: "column" }}>
                    ...
                    />
                    <View
                      style={{ borderBottomWidth: 1, marginTop: 5 * metrics }}
                    />
                    {/* {
            ...
            {!this.state.editing_email ? (
              <View style={styles.item}>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => this.setState({ editing_email: true })}
                  >
                    <MaterialIcons
                      name="edit"
                      color={Colors.main_blue_color}
              ...
              <View style={styles.editing_item}>
                <Text style={styles.type}>Email</Text>
                <View
                  style={{ flexDirection: "row", marginBottom: 10 * metrics }}
                >
