...
import { ActivityIndicator, AsyncStorage, Image, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
                            ...
                            <View style={{flex : 1, flexDirection : 'column'}}>
                                ...
                                <View style={{flex : 0.3 , flexDirection : 'column'}}>
                                    ...
                                    <View style={{marginTop : 10 * metrics , marginBottom : 10 * metrics}}>
                                        ...
                                        <Text style={styles.video_text}>I would like to open Orbit Account"</Text>
                                    </View>
                                    <View style={{marginTop : 20 * metrics}}></View>
