...
export default class VerifyEmailComponent extends Component {
  ...
  resendOTP() {
    ...
    UserService.resendEmailOTP(obj)
      .then((res) => {
        var data = res.data.result;
        if (data.success) alertMessage(ErrorMessage.success_email_otp);
        else alertMessage(ErrorMessage.failed_email_otp);
