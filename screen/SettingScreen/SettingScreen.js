...
export default class SettingScreen extends Component {
  ...
  onChangeFingerprint = () => {
    if (this.state.finger) {
      this.setState({ finger: !this.state.finger, show_finger: false }, () =>
        this.setLocalStorage()
      );
    } else {
      this.setState({ finger: !this.state.finger, show_finger: true }, () =>
        this.setLocalStorage()
      );
    }
  };
  ...
  handleBackButtonClick() {
    if (this.state.show_finger) {
      this.setState({ show_finger: false, finger: false }, () =>
        this.setLocalStorage()
      );
      return true;
    } else {
            ...
            <ScrollView style={{ flex: 1 }}>
              <View style={styles.avatar_body}>
                <Avatar
                  ...
                  size="xlarge"
                  source={{
                    uri: "data:image/png;base64," + global.user_info.selfie,
                  }}
                  resizeMode={"stretch"}
                  ...
                  <View>
                    ...
                    {global.user_info.company_name ? (
                      <Text style={styles.company_name}>
                        {global.user_info.company_name.toUpperCase()}
                      </Text>
                    ) : null}
                  </View>
                ) : (
              ...
              <View style={styles.body}>
                <View style={styles.setting_view}>
                  ...
                  <TouchableOpacity
                    style={styles.button}
                    onPress={() =>
                      this.props.navigation.navigate("PersonalSettingScreen")
                    }
                  >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ flex: 0.6, justifyContent: "center" }}>
                ...
                >
                  Remember this PIN. If you forget it, you 'll need to reset
                  your fingerprint.
                </Text>
                <CodePin
                  containerStyle={{
                  ...
                  text={
                    Platform.OS == "ios"
                      ? ""
                      : "Enter your security code to unlock"
                  } // My title
