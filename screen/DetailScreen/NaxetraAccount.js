...
import { ActivityIndicator, BackHandler, DatePickerAndroid, Image, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TimePickerAndroid, TouchableOpacity, View } from 'react-native';
...
export default class NaxetraScreen extends Component {
    ...
    componentDidMount() {
        ...
        analytics().setCurrentScreen("Orbit Account", "Orbit Account");
            ...
            <SafeAreaView style={{flex : 1}}>
                ...
                >
                {
                    ...
                    <View style={styles.container}>
                        <DetailHeaderComponent navigation={this.props.navigation}  title="Orbit Account"  goBack ={() => this.props.navigation.goBack()}></DetailHeaderComponent>
