            ...
            <View style={global_style.detail_header}>
                {
                    ...
                    <View style={{flex : 1, flexDirection : 'row'}}>
                        ...
                        {
                            (this.props.title == 'Payment Link' || this.props.title == "Orbit Account" || this.props.title == "Bank Account" || this.props.title == "Confirm Payment") && this.props.type != 'personal_setting' && this.props.type != 'account_setting' && this.props.type != 'price_setting' && this.props.type != 'company_setting' && this.props.type != 'chatting' && 
                        ...
                        {
                            (this.props.title != "Confirm Payment" && this.props.title != 'Payment Link' && this.props.title != 'Orbit Account' && this.props.title != 'Bank Account') &&  this.props.type != 'personal_setting' && this.props.type != 'account_setting' && this.props.type != 'price_setting' && this.props.type != 'company_setting' && this.props.type != 'chatting' &&
                            <View style={styles.header_right}>
                                <Text style={{fontSize : 18 * metrics,fontFamily : Fonts.adobe_clean, fontWeight : '500', color : '#000'}}>{this.props.title}</Text>
                            </View>
                        }
