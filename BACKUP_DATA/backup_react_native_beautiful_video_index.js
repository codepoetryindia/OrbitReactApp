    ...
    return (
      <Modal visible={isOpen} transparent animationType="fade"
        ...
        <View style={styles.modal}>
          ...
          {this.state.msg &&
          <View style={{position:'absolute', top:0, zIndex:5555, backgroundColor:'rgba(52, 52, 52, 0.3)', marginTop:60, padding:10}}>
          <Text style={{ color:'#fff', fontSize:16, textAlign:'center',          textShadowColor: 'rgba(255, 255, 255, 0.35)',
         textShadowOffset: {width: -1, height: 1},
         textShadowRadius: 10}}>{this.state.msg}</Text>
          </View>
        }
