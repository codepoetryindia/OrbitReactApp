...
export default class SplashScreen extends Component {
  ...
  async getStorageData() {
    ...
    if (
      ...
      global.user_info = JSON.parse(
        await AsyncStorage.getItem("register_user")
      );
      ...
      if (
        ...
        global.applicant_id == null ||
        global.user_info == "" ||
        global.applicant_id == "" ||
        global.verfiy_step == null ||
        global.verfiy_step == "" ||
        global.token == null ||
        global.token == ""
      ) {
  ...
  async setLocalStorage() {
    ...
    await AsyncStorage.setItem(
      "register_user",
      JSON.stringify(global.user_info)
    );
  }
  gotoFingerPrint() {
  ...
  async componentDidMount() {
    ...
    analytics().setCurrentScreen("Splash Screen", "Splash Screen");
  }
      ...
      >
        {!this.state.isAlreadyLogin ? (
          <View>
            ...
            <TouchableOpacity
              style={[global_style.spButton2, styles.ButtonShadow]}
              ...
              <View style={styles.another_body}>
                <CodePin
                  ...
                  checkPinCode={(code, callback) =>
                    callback(code === this.state.pin_code)
                  }
        ...
        {this.state.isLoading && (
          <View style={global_style.loading_body}>
            ...
            />
            <Text style={global_style.loading_text}>
