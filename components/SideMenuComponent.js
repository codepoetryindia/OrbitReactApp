      ...
      <>
        <View style={styles.container}>
            ...
            <View style={styles.user}>
              ...
              <View style={styles.user_info}>
                <Text style={styles.user_name}>
                  {global.user_info.first_name} {global.user_info.middle_name}{" "}
          ...
          <View style={styles.button_body}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={() => this.onBanking()}
              >
                <Image
                  source={Images.side_banking}
                  style={{
                    width: 28 * metrics,
                    height: 28 * metrics,
                    resizeMode: "stretch",
          ...
          <View style={styles.bottom}>
            <Image source={Images.small_logo} style={styles.logo} />
