        ...
        return (
            <View style={styles.container}>
                ...
                */}
                ...
                <View style={[styles.body, {marginTop : this.props.showType == 'category' ? 0 : 20 * metrics}]}>
                    {
                        this.state.item_arr.map((item, index) => {
                            ...
                            return (
                                <View style={styles.item} key={index}>
                                    ...
                                    <View style={{flex :0.18, flexDirection : 'row',paddingLeft : 10 * metrics, paddingRight : 10 * metrics}}>
                                        {
