...
export const error_password_max_length =
  "Password must be at least 6 characters long.";
export const error_password_pattern_match =
  "password must be eight characters long and contain at least one uppercase, one lowercase letter, one number, and one special character.";
...
export const network_error =
  "Unable to process details, please connect Orbit Support Team";
