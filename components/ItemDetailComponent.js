...
import { alertMessage, changeDatefromAccount, getHoursAndMins, getHoursAndMinsFromStr, paramDate2 } from '../utils/utils';
        ...
        if (global.file_path != '') {
            ...
            config(options)
                ...
                .then(response => {
                    ...
                    global.file_name = 'Orbit - ' + this.props.origin_data.transaction_number
                    global.trans_id = this.props.item.naxetra_id
                    this.props.navigation.navigate('PdfScreen')
                })
                .catch(err => {
                                    ...
                                    </View>
                                    {
                                        ...
                                        <View>
                                            ...
                                            <View style={styles.transaction_detail}>
                                                ...
                                                <View style={{flexDirection : 'row', marginTop : 10 * metrics}}>
                                                    <View style={{flex : 0.5}}>
                                                        <Text style={styles.detail_title}>Counter Party</Text>
                                                    </View>
                                                    <View style={{flex : 0.5}}>
                                                        <Text style={styles.detail_number}>{!this.props.origin_data.transaction_info_details ? '' : this.props.origin_data.transaction_info_details}</Text>
                                                    </View>
                                                </View>
                                            </View>
                                            ...
                                            <View style={styles.transaction_detail}>
                                                <View style={{flexDirection : 'row', marginTop : 10 * metrics}}>
                                                    <View style={{flex : 0.7}}>
                                                        <Text style={styles.detail_title}>{this.props.origin_data.source_type == 'bank' ? 'Orbit Money' : 'Card'}</Text>
                                                    </View>
                                                    <View style={{flex : 0.3}}>
                                                        <Text style={styles.detail_value}>{this.props.origin_data.bank_or_card_number}</Text>
                                                    </View>
                                                </View>
